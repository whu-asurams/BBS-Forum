...
<div class="message" align="left">
    ...
    <div class="message-body" align="left">
        ...
        {/IF}
        <font size="5" color="green"><b>{MESSAGE->subject}</b></font>
        <br /><br />
        {MESSAGE->body}
        ...
        {IF MODERATOR true}
            <div class="message-moderation">
                ...
                {ELSE}
                    &raquo; <a class="icon" href="{MESSAGE->URL->RECOMMEND_MESSAGE}">{LANG->eric_RecommendMessage}</a>
                {/IF}
                {IF MESSAGE->is_unapproved}
...
<table cellspacing="0" class="list">
    ...
    <tr>
        <td width="65%" class="message-subject-threaded {altclass}" align="left">
