            ...
            <table border="0" cellspacing="0">
                <tr>
                    <td width="100%">
                        ...
                        <small>
                        <a href="{MESSAGES->URL->READ}"><font size="4" color="green">{MESSAGES->subject}</font>{IF MESSAGES->new} <span class="new-flag">{LANG->New}</span>{/IF}<br />
                        {MESSAGES->datestamp}
                        </small>
                    </td>
            ...
            {IF MODERATOR true}
                <div class="message-moderation">
                    {IF MESSAGES->threadstart true}
                        ...
                        <a class="icon" href="{MESSAGE->URL->RECOMMEND_MESSAGE}">{LANG->eric_RecommendMessage}</a>
                    {ELSE}
