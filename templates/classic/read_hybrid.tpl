...
<div align="left" style="width:940px; overflow:auto; whitespace: nowrap; padding-left:10px; border: 1px solid green;">
   <br />
   <a href="{URL->LIST}">[{LANG->eric_return}]</a>
   <br />
   <br />
   <center>   
   <font size = "4" color="green">{LANG->eric_read_subject}</font><br />
   <font size = "3"><b>{LANG->eric_read_author} {LANG->eric_read_authorname}</b><br />
   </center>
   ...
   <font style="font-weight: 100; font-size: 14px; letter-spacing:0.5px;">{LANG->eric_read_body}</font>
<br />
<br />
<br />
   <br />
...
<div id="rnca_mybody" style="display: none">
  ...
  <br />
    ...
    <div class="message" style="padding-left: {MESSAGES->indent_cnt}px;">
        ...
        <div class="message-body" align="left">
