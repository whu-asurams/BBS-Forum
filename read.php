        ...
        foreach($messages as $key => $row) {
            ...
            if($PHORUM["count_views"]) {  // show viewcount if enabled
                  if($PHORUM["count_views"] == 2) { // viewcount as column
                      ...
                      if($messages[$key]["forum_id"] == 29 && $messages[$key]["message_id"] == 2810){
                      }else {
...
//
        ...
        $PHORUM["DATA"]["LANG"]["eric_read_subject"]=$PHORUM["DATA"]["MESSAGE"]["subject"] ;
             ...
             if($PHORUM["DATA"]["MESSAGE"]["forum_id"] == 29 && $PHORUM["DATA"]["MESSAGE"]["message_id"] == 2810)
             {             
        	$PHORUM["DATA"]["LANG"]["eric_read_author"]= " ";
                $PHORUM["DATA"]["LANG"]["eric_read_authorname"]=" ";
             }else{
